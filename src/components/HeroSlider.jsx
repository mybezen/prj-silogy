...
const HeroSlider = () => {
  ...
  const slides = [
    {
      id: 'grow',
      title: 'GROW',
      subtitle: 'Ketika tanaman tumbuh dengan memadukan nutrisi dan menyerap air dan nutrisi dari tanah untuk kebutuhan hidupnya yang akan hidup dengan sendirinya',
    ...
    },
    {
      id: 'decay',
      title: 'DECAY',
      subtitle: 'Sampah organik yang telah busuk dipengaruhi dengan kondisi cuaca dan lingkungan menjadi kompos yang sangat berguna',
    ...
    },
    {
      id: 'flow',
      title: 'FLOW',
      subtitle: 'Aliran air yang mengalirkan keharmonisan dengan lingkungan yang diiringi dengan ketenangan hati dan jiwa kita',
  ...
  const recycleSlide = {
    id: 'recycle',
    title: 'RECYCLE',
    subtitle: 'Sampah organik yang telah busuk dipengaruhi dengan kondisi cuaca dan lingkungan dapat dimanfaatkan kembali dan tidak terbuang sia-sia',
    image: 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=800&h=600&fit=crop',
  ...
  useEffect(() => {
    ...
    const material = new THREE.MeshPhongMaterial({ 
      color: currentData.id === 'grow' ? 0x4ade80 : 
             currentData.id === 'decay' ? 0xea580c :
             currentData.id === 'flow' ? 0x2563eb : 0x22c55e,
      shininess: 100,
      transparent: true,
      opacity: 0.7
    });
    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="text-center px-6 max-w-4xl mx-auto">
          ...
          <h1 className={`relative z-20 text-6xl md:text-8xl font-bold mb-6 ${currentData.textColor} tracking-wider drop-shadow-2xl`}>
            {currentData.title}
          </h1>

          {/* Subtitle */}
          <p className={`relative z-20 text-lg md:text-xl ${currentData.textColor} mb-8 max-w-2xl mx-auto leading-relaxed drop-shadow-lg`}>
